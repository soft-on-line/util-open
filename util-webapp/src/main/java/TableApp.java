 ...
 * @version $Id: TableApp.java 3148 2009-10-23 14:57:10Z shertage $
 */
public class TableApp extends AbstractSampleApp
{
	...
	{
//		main(new TableApp(), new String[]{"java","TableApp","xls"});
	    TableApp test = new TableApp();
	    test.xls();
	}
	...
	public void xls() throws JRException
	{
		long start = System.currentTimeMillis();
//		File sourceFile = new File("build/reports/TableReport.jrprint");
		File sourceFile = new File("d:/TableReport.jrprint");

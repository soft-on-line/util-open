...
public class FileUtil {
    ...
    public static int batchCopy(List<String> sourceList, String dstdir, boolean overwrite) {
    ...
    public static int batchCopy(List<String> fileList, String sourceDir, String dstDir, boolean overwrite) {
        int copySum = 0;

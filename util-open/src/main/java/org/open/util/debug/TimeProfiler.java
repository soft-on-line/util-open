...
/**
 * 性能监测，超过指定值的允许都将被记录。 如果把TimeProfiler 的log level定为info，则输出简要信息，如果设为debug，则输出详细信息
 * @author fish
 */
...
public final class TimeProfiler {
	...
	private static final int                       Default_Threshold    = 10;                                   // default

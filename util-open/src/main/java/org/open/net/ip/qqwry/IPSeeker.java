...
public class IPSeeker {
    ...
    private IPSeeker() {
        ...
        try {
            ...
            // try {
            // jarFile = new JarFile(
            // getClass().getProtectionDomain().getCodeSource().getLocation().getFile().toString());
            // JarEntry entry = jarFile.getJarEntry("org/open/net/ip/qqwry/QQWry.dat");
            //
            // WriterUtil.write(file, ReaderUtil.readByte(jarFile.getInputStream(entry)));
            // } catch (Exception e) {
            // // if read from jar failed and read from java source folder.
            // WriterUtil.write(
            // file,
            // ReaderUtil.readByte(getClass().getResourceAsStream("/org/open/net/ip/qqwry/QQWry.Dat")));
            // } finally {
            // if (null != jarFile) {
            // jarFile.close();
            // }
                ...
                ipFile = new RandomAccessFile(
                                              new File(
                                                       ClassLoader.getSystemClassLoader().getResource(
                                                                                                      "/org/open/net/ip/qqwry/QQWry.Dat").toURI()),
                                              "r");
            } catch (Exception e) {
                ipFile = new RandomAccessFile(new File(IPSeeker.class.getResource("QQWry.dat").toURI()), "r");
            }

        } catch (Exception e) {
            log.error("instance read QQWry.dat file error!", e);
        }
    ...
    public List<IPEntry> getIPEntries(String s) {
        ...
        try {
            ...
            log.error(BeanUtil.getMethodName(e) + "(" + s + ") error!", e);
        }
        return ret;
    }
    ...
    public String getIPInfo(String ip) {
        try {
            return getIPLocation(ip).getCountry() + ":" + getIPLocation(ip).getArea();
        } catch (Exception e) {
            return ip + " parser error!";
        }
    }
